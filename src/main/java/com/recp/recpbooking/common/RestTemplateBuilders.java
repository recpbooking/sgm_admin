...
public class RestTemplateBuilders {


    public static RestTemplate securityRestTemplateBuilder() {

        String userName = RestParameter.getRestUserName();
        String password = RestParameter.getRestPassword();
